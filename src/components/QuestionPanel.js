...
const questions = [
  ...
  {
    title:
      "2a Which of these is your biggest priority in your hub of innovation at the moment?",
    answers: [
      [
  ...
  {
    title:
      "2b Which of these is your biggest priority in your hub of innovation at the moment?",
    answers: [
      [
  ...
  render() {
    return (
      <div
        id="slideable"
        style={{
          top: positions[this.props.panelProperties.position] + "%",
          visibility: this.props.panelProperties.visible ? "visible" : "hidden",
        }}
      >
        <div>
          <button
